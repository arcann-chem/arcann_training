...
for it0_subsys_nr,it_subsys_nr in enumerate(subsys_name):
    ...
    config_json['subsys_nr'][it_subsys_nr]['nb_candidates_max'] = 500 if 'nb_candidates_max' not in globals() else nb_candidates_max[nit0_subsys_nr]
...
del config_json,training_iterative_apath,config_json_fpath,datasets_initial_json

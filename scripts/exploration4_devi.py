    ...
    for it_nnp in range(1, exploration_json['nb_nnp'] + 1):
        ...
        for it_each in range(1, exploration_json['nb_traj']+1):
            ...
            if Path('./skip').is_file() is False:
                ...
                devi_json['std_max_devi_f'] = 999
                devi_json['nb_total'] = expected
                devi_json['nb_good'] = 0
                devi_json_index['good_ind'] = []
                devi_json['nb_rejected'] = expected
                devi_json_index['rejected_ind'] = []
                devi_json['nb_candidates'] = 0
                devi_json_index['candidates_ind'] = []

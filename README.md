...
- `temperature_K`, a list of floats containing the temperature at which the exploration of each subsystem will be performed. **DEFAULT** is 298.15 K for all subsystems.

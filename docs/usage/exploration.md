...
> **Workflow**: [Training](./training.md) > **Exploration** > [Labeling](./labeling.md) > [Training (next iteration)](./training.md) or [Testing](./test.md)
...
**Previous**: [Training](./training.md) | **Next**: [Labeling](./labeling.md)
